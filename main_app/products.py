products = [
  {
    '_id': "1",
    'name': "MK4 VW Emblem",
    'image': "/images/vwmk4EmbelmBalck.jpeg",
    'description':
      "Steering Wheel Horn Badge replacement- High quality,Polyuerthane Resin Carbon Fiber",
    'carModel': "Mk4",
    'carMake': "Volkswagen",
    'price': 30.0,
    'countInStock': 30,
  ...
  },
  {
    ...
    'price': 30.0,
    'countInStock': 50,
    'color': ["VW Black-A", "VW Blue", "VW Red", "Mirror Polish"],
  },
  {
    '_id': "3",
    'name': "VW Blue Wheel Emblem",
    'image':"/images/4pcs-65mm-volkswagen-logo-wheel-center-caps-vw-blue-30993950146740_664x664.jpg",
    'description':
  ...
  {
    '_id': "4",
    'name': "Mk 1 Shift Knobs",
    'image': "/images/shiftknob.jpg",
    'description':
